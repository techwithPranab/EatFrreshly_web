...
import { analytics, pageTracking } from '@/utils/analytics';
  ...
  const fetchMenuData = async () => {
    try {
      ...
      if (menuResponse.data.success) {
        const items = menuResponse.data.data.items;
        setMenuItems(items);
        
        // Track menu page view with items
        analytics.viewItemList(items, 'Menu Page');
      }
